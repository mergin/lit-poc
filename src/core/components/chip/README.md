...
| Part            | Description                                             |
| --------------- | ------------------------------------------------------- |
| `chip`          | The outer chip container element.                       |
| `label`         | The text label inside the chip.                         |
| `delete-button` | The delete icon button (only present when `deletable`). |

## CSS Custom Properties

| Property           | Description                      | Default   |
| ------------------ | -------------------------------- | --------- |
| `--mu-chip-radius` | Border radius of the chip.       | `16px`    |
| `--mu-chip-height` | Height of the chip.              | `32px`    |
| `--mu-chip-bg`     | Background for the default chip. | `#e0e0e0` |
