...
`;let ft=class extends ht{constructor(){super(...arguments),this.size="medium",this.variant="contained",this.color="primary",this.disabled=!1}render(){return W`
      <button
    ...
    `],t([lt({type:String})],ft.prototype,"size",void 0),t([lt({type:String})],ft.prototype,"variant",void 0),t([lt({type:String})],ft.prototype,"color",void 0),t([lt({type:Boolean,reflect:!0})],ft.prototype,"disabled",void 0),ft=t([(t=>(i,s)=>{void 0!==s?s.addInitializer(()=>{customElements.define(t,i)}):customElements.define(t,i)})("mu-button")],ft);export{ft as MuButton};
